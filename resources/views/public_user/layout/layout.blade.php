...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user/main/main.css') }}">
            ...
            <div class="container">
                <div class="containt_main">
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="{{ route('index_first') }}">Home</a>

                    </div>
                    <span class="toggle_icon" onclick="openNav()"><img src="{{asset('user/images/images/toggle-icon.png')}}"></span>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Category
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('index_first') }}">home</a>
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="footer_section layout_padding">
                    <div class="container">
                        ...
                        <div class="location_main"> Number : <a href="#">+201204016075</a></div>
                    </div>
                </div>
                <!-- footer section end -->
                ...
                <div class="copyright_section">
                    <div class="container">
                        <p class="copyright_text">©  Design by <a
                ...
                <script src="{{ asset('user/main/main.js') }}"></script>
                @stack('javas')
</body>
